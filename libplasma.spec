...
Version  : 6.1.2
Release  : 12
URL      : https://download.kde.org/stable/plasma/6.1.2/libplasma-6.1.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.2/libplasma-6.1.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.2/libplasma-6.1.2.tar.xz.sig
...
%setup -q -n libplasma-6.1.2
cd %{_builddir}/libplasma-6.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720534349
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasma.so.6.1.2
/usr/lib64/libPlasmaQuick.so.6
/usr/lib64/libPlasmaQuick.so.6.1.2
