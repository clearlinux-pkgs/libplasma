...
Source0  : https://download.kde.org/stable/plasma/6.2.5/libplasma-6.2.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.5/libplasma-6.2.5.tar.xz.sig
...
%setup -q -n libplasma-6.2.5
cd %{_builddir}/libplasma-6.2.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736175652
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasma.so.6.2.5
/usr/lib64/libPlasmaQuick.so.6
/usr/lib64/libPlasmaQuick.so.6.2.5
