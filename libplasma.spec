...
Version  : 6.4.0
Release  : 28
URL      : https://download.kde.org/stable/plasma/6.4.0/libplasma-6.4.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.4.0/libplasma-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.4.0/libplasma-6.4.0.tar.xz.sig
...
%setup -q -n libplasma-6.4.0
cd %{_builddir}/libplasma-6.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750176878
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasma.so.6.4.0
/usr/lib64/libPlasmaQuick.so.6
/usr/lib64/libPlasmaQuick.so.6.4.0
...
/usr/lib64/qt6/qml/org/kde/plasma/components/StackView.qml
...
/usr/lib64/qt6/qml/org/kde/plasma/core/DefaultToolTip.qml
/usr/lib64/qt6/qml/org/kde/plasma/core/DialogBackground.qml
...
/usr/lib64/qt6/qml/org/kde/plasma/extras/ListSectionHeader.qml
