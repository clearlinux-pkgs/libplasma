...
Version  : 6.1.3
Release  : 13
URL      : https://download.kde.org/stable/plasma/6.1.3/libplasma-6.1.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.3/libplasma-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/libplasma-6.1.3.tar.xz.sig
...
%setup -q -n libplasma-6.1.3
cd %{_builddir}/libplasma-6.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721140131
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasma.so.6.1.3
/usr/lib64/libPlasmaQuick.so.6
/usr/lib64/libPlasmaQuick.so.6.1.3
