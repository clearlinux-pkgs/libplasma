...
Source0  : https://download.kde.org/stable/plasma/6.1.4/libplasma-6.1.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.4/libplasma-6.1.4.tar.xz.sig
...
%setup -q -n libplasma-6.1.4
cd %{_builddir}/libplasma-6.1.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723127092
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasma.so.6.1.4
/usr/lib64/libPlasmaQuick.so.6
/usr/lib64/libPlasmaQuick.so.6.1.4
