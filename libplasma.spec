...
Version  : 6.0.0
Release  : 1
URL      : https://download.kde.org/stable/plasma/6.0.0/libplasma-6.0.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.0/libplasma-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.0/libplasma-6.0.0.tar.xz.sig
...
%prep
%setup -q -n libplasma-6.0.0
cd %{_builddir}/libplasma-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709392889
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasma.so.6.0.0
/usr/lib64/libPlasmaQuick.so.6
/usr/lib64/libPlasmaQuick.so.6.0.0
